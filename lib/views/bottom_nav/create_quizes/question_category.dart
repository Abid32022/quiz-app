...
class QuestionCategory extends StatefulWidget {
  QuestionCategory({Key? key,required this.data}) : super(key: key);

  final MyData data;

  @override
  State<QuestionCategory> createState() => _QuestionCategoryState();
}
                ...
                decoration: BoxDecoration(
                 ...
                 // border: Border.all(color: Colors.grey),
                  image:  DecorationImage(
                    image: FileImage(File(Imagescontroller.imagePath2.toString())),fit: BoxFit.fitWidth,
                  ),
                ),
              ),
              ...
              Container(
                ...
                child:Row(
                  children: [
                    ...
                    customTextRegular(title: widget.data.text8,fontWeight: FontWeight.w500,color: AppColors.grey97,fontSize: MySize.size14),
                  ],
                ),
              ),
              SizedBox(height: MySize.size15,),
          ...
          RichText(text: TextSpan(
              ...
              //  WidgetSpan(child: SizedBox(width: MySize.size40,)),
                TextSpan(
                  ...
                  text: index ==0 ? widget.data.text4 :index ==1 ?widget.data.text5:index ==2 ? widget.data.text6 :index ==3 ?widget.data.text7:null,
