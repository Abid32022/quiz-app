...
class CheckBoxAnswers extends StatefulWidget {
  const CheckBoxAnswers({Key? key,required this.data}) : super(key: key);
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image:  DecorationImage(
                    image: FileImage(File(Imagescontroller.imagePath3.toString())),fit: BoxFit.fitWidth,
                  ),
                ),
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  customTextRegular(title: "+ Add",fontWeight: FontWeight.w500,color: AppColors.grey97,fontSize: MySize.size12),
                ],
              ),
              ...
              Theme(
                ...
                child: Container(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Container(
                      child:
                      customTextRegular(title:"Mathematics",fontSize:MySize.size16,fontWeight: FontWeight.w600,color: AppColors.black  ),
                    ),
              ...
              Wrap(
                ...
                children: List.generate(
                    ...
                    GestureDetector(
                      ...
                      child: checkboxPart(index),
                    )
                ),
              ),
              SizedBox(height: MySize.size30,),
              custombutton2(text: "Publish",height: MySize.size50,ontap: (){
              // Get.to(()=>CheckBoxAnswers(data: CheckBoxModel));
              },
          ...
          Container(
            ...
            width: MySize.size17,
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color:index==isTrue?  AppColors.green:AppColors.grey89),
                ),
            child: Center(child: Icon(Icons.check,color:index==isTrue?  AppColors.green:Colors.transparent ,size: 10,)),
          ),
